...
/** 
 * @brief Essa função remove o acento dos caracteres para facilitar a ordenação
 ...
 * @return wstring  a string da resposta formatada como "{palavra}: {número de ocorrências}\n", para cada palavra
 */
